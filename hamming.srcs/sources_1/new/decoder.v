...
//hamming_in = [0, 0, 1, 1, 0, 0, 1, 1]
//hamming_error = []
//reg [0:length-1] hamming_error = 'b00100001;
//hamming_error[3]=0 #error
//hamming_error[7]=0 # double error
...
while (n<length) begin
    ...
    while(d<length) begin
        ...
        d=d+n; //bity danych nie brancyh do oblicznia parity  
    end
    if(s%2!=0) begin
        syndrome=syndrome+n;
    end
